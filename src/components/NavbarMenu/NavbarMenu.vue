    ...
    <div>
        <div class="navbar">
            ...
            <div class="location d-flex align-items-center"
                style="background-color: #DFDCF5; padding: 8px; gap: 8px; border-radius: 16px;">
                <section class="icon">
                    <img src="/icon/location.svg" alt="">
                </section>
                <section class="text mx-1">
                    <span style="color: #4E40A1; font-weight: 400; font-family: sans-serif;">Beruniy ko’chasi, 5</span>
                </section>
            </div>
            <div class="notification d-flex align-items-center">
                <section class="likes mx-2 d-flex align-items-center h6 justify-content-center" style="background-color: #DFDCF5; cursor: pointer;  border-radius: 100%; width: 40px;
                height: 40px;">
                    <i class="fa fa-heart" style="color: #4E40A1;"></i>
                    <span class="badge position-absolute d-block d-flex justify-content-center align-items-center" style="transform: translate(15px, -25px); background-color: #4E40A1; border-radius: 100%; width: 30px;
                    height: 30px;">234</span>
                </section>
...
@media (max-width: 768px) {
    .navbar .notification[data-v-33487852] {
